...
public class cbuildParser extends Parser {
	...
	public static final int
		...
		PLUS=36, QUESTION=37, BANG=38, CHARS=39, NL=40, LEADING_TAB=41, WS=42, 
		TAB=43, COMMENT=44;
	public static final int
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			"VPATH", "ESCAPED_QUOTE", "SLIT", "HOOK", "BACKSLASH", "PLUS", "QUESTION", 
			"BANG", "CHARS", "NL", "LEADING_TAB", "WS", "TAB", "COMMENT"
		};
	}
	...
	public final Define_bodyContext define_body() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 18693778046976L) != 0)) {
				{
				setState(417);
				_errHandler.sync(this);
				switch (_input.LA(1)) {
	...
	public final Expressions_optContext expressions_opt() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 14272176326206L) != 0)) {
				{
				setState(505);
				expressions();
				}
	...
	public final First_expr_in_defContext first_expr_in_def() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 18674517409342L) != 0)) {
				{
				setState(603);
				expr_in_recipe();
				}
	...
	public final ExpressionContext expression() throws RecognitionException {
		...
		try {
			...
			do {
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
			} while ( (((_la) & ~0x3f) == 0 && ((1L << _la) & 1078036792894L) != 0) );
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final Expr_nestedContext expr_nested() throws RecognitionException {
		...
		try {
			...
			do {
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
			} while ( (((_la) & ~0x3f) == 0 && ((1L << _la) & 1078036809278L) != 0) );
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final Expr_in_assignContext expr_in_assign() throws RecognitionException {
		...
		try {
			...
			do {
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
			} while ( (((_la) & ~0x3f) == 0 && ((1L << _la) & 1082331332158L) != 0) );
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final Expr_in_recipeContext expr_in_recipe() throws RecognitionException {
		...
		try {
			...
			do {
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
			} while ( (((_la) & ~0x3f) == 0 && ((1L << _la) & 18674517409342L) != 0) );
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final Function_nameContext function_name() throws RecognitionException {
		...
		try {
			...
			do {
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
			} while ( (((_la) & ~0x3f) == 0 && ((1L << _la) & 549755813916L) != 0) );
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final PrerequisitesContext prerequisites() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 554050354204L) != 0)) {
				{
				setState(817);
				targets();
				}
	...
	public final Recipes_optContext recipes_opt() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 34084876189696L) != 0)) {
				{
				setState(838);
				recipes();
				}
	...
	public final CharContext char_() throws RecognitionException {
		...
		try {
			...
			setState(901);
			_la = _input.LA(1);
			if ( !((((_la) & ~0x3f) == 0 && ((1L << _la) & 1078036791842L) != 0)) ) {
			_errHandler.recoverInline(this);
			}
			else {
				if ( _input.LA(1)==Token.EOF ) matchedEOF = true;
