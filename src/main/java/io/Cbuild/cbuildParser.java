...
public class cbuildParser extends Parser {
	...
	public static final int
		...
		DEFINE=30, VPATH=31, SLIT=32, YSHARP=33, CHARS=34, NL=35, LEADING_TAB=36, 
		WS=37, TAB=38, COMMENT=39;
	public static final int
	...
	private static String[] makeLiteralNames() {
		return new String[] {
			...
			"'define'", "'vpath'", null, "'ysharp'", null, null, null, null, "'\\t'"
		};
	}
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			"VPATH", "SLIT", "YSHARP", "CHARS", "NL", "LEADING_TAB", "WS", "TAB", 
			"COMMENT"
		};
	}
	...
	public final Expressions_optContext expressions_opt() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 433791698494L) != 0)) {
				{
				setState(436);
				expressions();
				}
	...
	public final First_expr_in_defContext first_expr_in_def() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 584115146302L) != 0)) {
				{
				setState(534);
				expr_in_recipe();
				}
	...
	public final ExpressionContext expression() throws RecognitionException {
		...
		try {
			...
			do {
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
			} while ( (((_la) & ~0x3f) == 0 && ((1L << _la) & 21474838078L) != 0) );
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final Expr_nestedContext expr_nested() throws RecognitionException {
		...
		try {
			...
			do {
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
			} while ( (((_la) & ~0x3f) == 0 && ((1L << _la) & 21474854462L) != 0) );
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final Expr_in_assignContext expr_in_assign() throws RecognitionException {
		...
		try {
			...
			do {
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
			} while ( (((_la) & ~0x3f) == 0 && ((1L << _la) & 34359299646L) != 0) );
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final Expr_in_recipeContext expr_in_recipe() throws RecognitionException {
		...
		try {
			...
			do {
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
			} while ( (((_la) & ~0x3f) == 0 && ((1L << _la) & 584115146302L) != 0) );
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final Function_nameContext function_name() throws RecognitionException {
		...
		try {
			...
			do {
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
			} while ( (((_la) & ~0x3f) == 0 && ((1L << _la) & 17179869212L) != 0) );
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final PatternContext pattern() throws RecognitionException {
		...
		try {
			...
			do {
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
			} while ( (((_la) & ~0x3f) == 0 && ((1L << _la) & 30064331804L) != 0) );
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final PrerequisitesContext prerequisites() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 30064331804L) != 0)) {
				{
				setState(748);
				targets();
				}
	...
	public final Recipes_optContext recipes_opt() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 1065167618048L) != 0)) {
				{
				setState(769);
				recipes();
				}
	...
	public final CharContext char_() throws RecognitionException {
		...
		try {
			...
			setState(830);
			_la = _input.LA(1);
			if ( !((((_la) & ~0x3f) == 0 && ((1L << _la) & 21474837026L) != 0)) ) {
			_errHandler.recoverInline(this);
			}
			else {
				if ( _input.LA(1)==Token.EOF ) matchedEOF = true;
	...
	public final KeywordsContext keywords() throws RecognitionException {
		...
		try {
			...
			setState(888);
			_la = _input.LA(1);
			if ( !((((_la) & ~0x3f) == 0 && ((1L << _la) & 12884443136L) != 0)) ) {
			_errHandler.recoverInline(this);
			}
			else {
				if ( _input.LA(1)==Token.EOF ) matchedEOF = true;
